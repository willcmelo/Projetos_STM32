...
const struct regval_list ov7670_default_regs[] = {//from the linux driver
  ...
  */
  { REG_HSTART, 0x05 }, { REG_HSTOP, 0x70},//0x01
  { REG_HREF, 0x70 }, { REG_VSTART, 0x03 }, //OxB6 , 0x02
  { REG_VSTOP, 0x7b }, { REG_VREF, 0 },
...
void captureImg(uint16_t wg, uint16_t hg)
{
	...
	// wrReg(REG_CLKRC, 8);  // alterado para melhorar a imagem durante  o loop sem apertar o botão de tirar foto
	uint16_t y, x, pixel;
